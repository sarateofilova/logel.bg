	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1 ) {
				...
				/* Default menu - parent dropdown does not support click */
				/*
				$atts['href']          = '#';
				$atts['data-toggle']   = 'dropdown';
				*/
				
				/* Our menu - parent dropdown SUPPORT click */
				$atts['href']          = ! empty( $item->url ) ? $item->url : ''; //Three leve - Original '#'
				//$atts['data-toggle']   = 'dropdown'; //Three level - Original - remove the comment
